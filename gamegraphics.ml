...
let draw_board t n = 
  ...
  print_string("       >-----");settlement_draw n 12;print_string("  ");print_string(grab_resource t 3);print_string("   ");settlement_draw n 13;draw_edge "-----" (13,14) n;settlement_draw n 14;print_string("   ");print_string(grab_resource t 4);print_string("  ");settlement_draw n 15;draw_edge "-----" (15,16) n;settlement_draw n 16;print_string("   ");print_string(grab_resource t 5);print_string("  ");settlement_draw n 17;print_string("-----< ");ANSITerminal.(print_string [white] "                            Gain 2 Points for having the longest road when road is length 5+ (if tied first to get longest) \n");
  print_string("      /~~~~~~~");draw_edge "\\" (12,18) n;print_string("         ");draw_edge "/" (13,19) n;print_string("       ");draw_edge "\\" (14,20) n;print_string("         ");draw_edge "/" (15,21) n;print_string("       ");draw_edge "\\" (16,22) n;print_string("         ");draw_edge "/" (17,23) n;print_string("~~~~~~~\\ ");ANSITerminal.(print_string [white] "                           Gain 2 Points for having the largest army (Player with 3+ knight cards and the most knight cards) \n");
