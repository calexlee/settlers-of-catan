...
let draw_board t n = 
  ...
  print_string("               /~~~~~~~\\~~~~~~~~~");draw_edge "/" (0,3) n;print_string("       ");draw_edge "\\" (1,4) n;print_string("~~~~~~~~~/~~~~~~~\\ ");ANSITerminal.(print_string [white] "                                    Road (worth 0 Points): Wood, Brick \n");
  print_string("              /~~~2:1~~~\\~~~~~~~");draw_edge "/" (0,3) n;print_string("   ");print_string(grab_num t 0);print_string("    ");draw_edge "\\" (1,4) n;print_string("~~~~~~~/~~~2:1~~~\\ \n");
  print_string("       >-----<~~~sheep~~~*");settlement_draw n 2;draw_edge "-----" (2,3) n;settlement_draw n 3;print_string("  ");print_string(grab_resource t 0);print_string("  ");settlement_draw n 4;draw_edge "-----" (4,5) n;settlement_draw n 5;print_string("*~~rock~~~>-----< ");ANSITerminal.(print_string [white] "                             Settlement (worth 1 Point): Brick, Wood, Wheat, Sheep \n");
  ...
  print_string("     /~~~~~~~~~\\~~~~~~*");draw_edge "/" (2,7) n;print_string("   ");print_string(grab_num t 1);print_string("    ");draw_edge "\\" (3,8) n;print_string("       ");draw_edge "/" (4,9) n;print_string("    ");print_string(grab_num t 2);print_string("   ");draw_edge "\\" (5,10) n;print_string("*~~~~~~/~~~~~~~~~\\ ");ANSITerminal.(print_string [white] "                          City (worth 2 Points): Wheat, Wheat, Rock, Rock, Rock \n");
  ...
  print_string("     \\~~~~~~~~~");draw_edge "/" (6,12) n;print_string("       ");draw_edge "\\" (7,13) n;print_string("         ");draw_edge "/" (8,14) n;print_string("       ");draw_edge "\\" (9,15) n;print_string("         ");draw_edge "/" (10,16) n;print_string("       ");draw_edge "\\" (11,17) n;print_string("~~~~~~~~~/ ");ANSITerminal.(print_string [white] "                          Development Card (varies based on card): Sheep, Wheat, Rock \n");
  ...
  print_string("       >-----");settlement_draw n 12;print_string("  ");print_string(grab_resource t 3);print_string("   ");settlement_draw n 13;draw_edge "-----" (13,14) n;settlement_draw n 14;print_string("   ");print_string(grab_resource t 4);print_string("  ");settlement_draw n 15;draw_edge "-----" (15,16) n;settlement_draw n 16;print_string("   ");print_string(grab_resource t 5);print_string("  ");settlement_draw n 17;print_string("-----< ");ANSITerminal.(print_string [white] "                            Gain 2 Points for having the longest road > 5 (if tied first to get longest) \n");
  print_string("      /~~~~~~~");draw_edge "\\" (12,18) n;print_string("         ");draw_edge "/" (13,19) n;print_string("       ");draw_edge "\\" (14,20) n;print_string("         ");draw_edge "/" (15,21) n;print_string("       ");draw_edge "\\" (16,22) n;print_string("         ");draw_edge "/" (17,23) n;print_string("~~~~~~~\\ ");ANSITerminal.(print_string [white] "                           Gain 2 Points for having the largest army (most Knights with min 3) \n");
  ...
  print_string("    <~~~wood~~* ");settlement_draw n 18;draw_edge "-----" (18,19) n;settlement_draw n 19;print_string("  ");print_string(grab_resource t 6);print_string("   ");settlement_draw n 20;draw_edge "-----" (20,21) n;settlement_draw n 21;print_string("     ");print_string(grab_num t 7);print_string("    ");settlement_draw n 22;draw_edge "-----" (22,23) n;settlement_draw n 23;print_string("*~~brick~~> \n");
